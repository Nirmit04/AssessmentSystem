...
const routes: Routes = [
	...
	{ path: 'cc-dash', component: UserDetailsComponent, canActivate: [AuthGuard], data: { roles: '2'}},
	{ path: 'login', component: LoginComponent },
	{ path: 'cc-dash/tag', component: TagComponent, canActivate: [ AuthGuard ], data: { roles: '2'} },
	{ path: 'cc-dash/quiz', component: RetrieveQuizComponent, canActivate: [AuthGuard], data: { roles: '2'} },
	{ path: 'cc-dash/rqbank', component: RetrieveQuestionBankComponent, canActivate: [AuthGuard], data: { roles: '2'} },
	{ path: 'cc-dash/create-question', component: CreateQuestionsComponent, canActivate: [AuthGuard], data: { roles: '2'} },
	{ path: 'cc-dash/archive-quiz', component: ArchiveQuizComponent, canActivate: [AuthGuard], data: { roles: '2'} },
	{ path: 'ta-dash/testAdminCreateScheDule', component: CreateScheduleComponent, canActivate: [AuthGuard], data: { roles: '1'} },
	{ path: 'ta-dash/retrieve-schedule', component: RetrieveScheduleComponent, canActivate: [AuthGuard], data: { roles: '1'} },
	{ path: 'ta-dash', component: TestAdminComponent, canActivate: [AuthGuard], data: { roles: '1'}},
	{ path: 'ta-dash/archive-schedule', component: ArchivedScheduleComponent, canActivate: [AuthGuard], data: { roles: '1'} },
	{ path: 'emp-dash/non-mocks', component: NonMockComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash', component: EmployeeComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash/quiz/take-quiz', component: TakeQuizComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash/quiz/result', component: ResultComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash/quiz/non-mock-report', component: NonMockReportComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash/quiz/detailed-report', component: DetailedReportComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash/mock', component: MockComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'emp-dash/mock-report', component: MockReportComponent, canActivate: [AuthGuard], data: { roles: '3'} },
	{ path: 'ta-dash/add-user', component: AddUserComponent, canActivate: [AuthGuard], data: { roles: '1'} },
	{ path: 'ru-dash', component: ReportingUserComponent, canActivate: [AuthGuard], data: { roles: '4'} },
	{ path: 'ru-dash/ana-by-user', component: AnalyticsByUserComponent, canActivate: [AuthGuard], data: { roles: '4'} },
	{ path: 'ru-dash/ana-by-tag', component: AnalyticsByTagComponent, canActivate: [AuthGuard], data: { roles: '4'} },
	{ path: 'ru-dash/ana-by-quiz', component: AnalyticsByQuizComponent, canActivate: [AuthGuard], data: { roles: '4'} },
